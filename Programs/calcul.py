...
btnClear = Button(cal,padx=14,pady=16,bd=8,fg='black', font=('arial', 20,'bold'),
...
text='=', bg = 'powder blue', command = equals).grid(row=4,column=2)
Dev = Button(cal,padx=16,pady=16,bd=8,fg='black', font=('arial', 20,'bold'),
